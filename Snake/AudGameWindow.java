...
public abstract class AudGameWindow extends JFrame {
     ...
     *
     * @param timerInterval The time in milliseconds between game ticks.
     */
     ...
     *
     * @param value the new width of the game area in pixels
     */
     ...
     *
     * @param value the new height of the game area in pixels
     */
     ...
     *
     * @param keyCodes The repeatable keys.
     ...
     *
     * @return the system time in milliseconds at which the start() method was called
     */
     ...
     *
     * @param g A Graphics object (actually Graphics2D) that can be used for
     *          painting the game.
     */
     ...
     *
     * @param keyCode The pressed key. The value is the one of the key codes
